...
function publicarEncuesta(id_encuesta) {
    ...
    if (conf == true) {
        ...
        $.post("../controladores/funcionesProfesorphp/encuestasprofesorphp/publicarEncuesta.php", {id_encuesta: id_encuesta}, function (data, status) {
            // Volver a cargar la tabla de encuestas
            mostrarEncuestas();
        });
    }
...
function finalizarEncuesta(id_encuesta) {
    ...
    if (conf == true) {
        // Publicar encuesta con el método ajax POST
        $.post("../controladores/funcionesProfesorphp/encuestasprofesorphp/finalizarEncuesta.php", {id_encuesta: id_encuesta}, function (data, status) {
            // Volver a cargar la tabla de encuestas
            mostrarEncuestas();
        });
    }
